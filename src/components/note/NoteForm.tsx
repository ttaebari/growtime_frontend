...
const NoteForm: FC<NoteFormProps> = ({
    ...
    <div className="flex flex-col p-6 h-full">
        <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-800">{isCreating ? "새 회고 작성" : "회고 수정"}</h2>
            <button onClick={onCancel} className="text-gray-500 transition-colors hover:text-gray-700">
        ...
        <form onSubmit={onSubmit} className="flex flex-col flex-1">
            ...
            <div className="mb-4">
                <label htmlFor="developType" className="block mb-2 text-sm font-medium text-gray-700">
                    개발 타입
                </label>
                <select
                    id="developType"
